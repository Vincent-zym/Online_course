...
<body>
	<!--上面-->
		<div class="top1">
			...
			<div class="top1_2">
				<button class="top1_2_1"><a href="stuLogin.jsp">学生端登录</a></button>
			</div>
		</div>
		<!--中间主体-->
		<div class="middle">
			...
			<div class="middle1">
				...
				<div class="login2_2" id="denglu">
					<form method="post" action="/adm_login">
						<div class="login1_2_2">工&nbsp;&nbsp;&nbsp;号：</div>
						<input class="text1" type="text" name="adm_id" placeholder="六位工号" />
						<div class="login1_2_2">密&nbsp;&nbsp;&nbsp;码：</div>
						<input class="text1" type="password" name="adm_pwd" placeholder="密码" />
						<input class="reset" type="reset" value="重置" />
						<input class="submit" type="submit" value="登录" />
					</form>
				</div>
				<div class="login1" id="zhuce">
					<form method="post" action="/adm_reg" >
						<div class="login1_1_1">手机号：</div>
						<input class="text" type="text" name="adm_tel" placeholder="86+" />
						<div class="login1_1_1">工&nbsp;&nbsp;&nbsp;号：</div>
						<input class="text" type="text" name="adm_id" placeholder="6位有效学号" />
						<div class="login1_1_1">密&nbsp;&nbsp;&nbsp;码：</div>
						<input class="text" type="password" name="adm_pwd" placeholder="至少6个字符" />
						<input class="reset" type="reset" value="重置" />
