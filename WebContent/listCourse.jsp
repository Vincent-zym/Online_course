...
<body>
	<div class="top1">
			...
			<div style="height: 40px; text-align: center;">
				<span style="font-size: 30px; ">管&nbsp;&nbsp;&nbsp;理&nbsp;&nbsp;&nbsp;员&nbsp;&nbsp;&nbsp;操&nbsp;&nbsp;&nbsp;作&nbsp;&nbsp;&nbsp;页&nbsp;&nbsp;&nbsp;面</span>
			</div>
			
        <div class="container">
            <div class="col-md-8 col-md-offset-2" style="width: 100%;margin: 0 auto">
                <h2>管理操作</h2><br>
                <button class="btn btn-info" onclick="window.location.href='/list'" style="margin-right:50px;margin-bottom: 30px">课程列表</button>
                <button class="btn btn-success" onclick="window.location.href='/add'" style="margin-right:50px;margin-bottom: 30px">添加课程</button>
                <button class="btn btn-info" onclick="window.location.href='/listStu'" style="margin-right:50px;margin-bottom: 30px">学生列表</button>
                <button class="btn btn-success" onclick="window.location.href='/addStu'" style="margin-bottom: 30px">添加学生</button>
                <table class="table">
                    <thead>
                        <td>课程ID</td>
                        <td>课程名字</td>
                    ...
                    <tbody>
                        ...
                        <c:forEach items="${courseList}" var="course">
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm" href="/update?course_id=${course.course_id}">更 新</a>
                                    <a class="btn btn-danger btn-sm" href="/delete?course_id=${course.course_id}">删 除</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
