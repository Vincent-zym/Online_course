            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <form action="/update" method="post">
                    <div class="form-group">
                        <label>课程编号</label>
                        <input type="hidden" class="form-control" name="course_id" value="${course.course_id }">
                    </div>
                    <div class="form-group">
                        <label>课程名字</label>
                    ...
                    <div class="form-group">
                        <label>授课老师</label>
                        <input type="text" class="form-control" name="course_tea" value="${course.course_tea }">
                    </div>
                    <div class="form-group">
                        <label>学时</label>
                        <input type="text" class="form-control" name="course_hour" value="${course.course_hour }">
                    </div>
                    <div class="form-group">
                        <label>学分</label>
                        <select class="form-control" name="course_mark" value="${course.course_mark }">
						  <option>0.5</option>
						  <option>1</option>
						  <option>1.5</option>
						  <option>2</option>
                    ...
                    <div class="form-group">
                        <label>上课地点</label>
                        <input type="text" class="form-control" name="course_place" value="${course.course_place }">
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-info">更新课程</button>
                    </div>
                </form>
            </div>
        </div>
